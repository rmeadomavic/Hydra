...
Set the serial port you wired to the VTX as MSP protocol. For example, if you used SERIAL6:
...
3. Confirm wiring: FC TX to VTX RX, common GND
4. In Mission Planner OSD tab, verify the message panel is positioned on screen
5. Test without Hydra first. Normal ArduPilot OSD elements (battery, GPS, etc.) should appear. If they don't, the issue is FC-to-VTX wiring or parameters.
